...
/*<95GUI_MODIF_BEGIN>*/
	/* many modifications performed on this file Nicolas Witczak july 1998 */
/*<95GUI_MODIF_END>*/
...
/*<95GUI_MODIF_BEGIN>*/
#ifndef __WIN95__
	static /*static removed : I need to access in another file*/
#endif /* __WIN95__ */
/*<95GUI_MODIF_END>*/
...
#ifdef CHANNEL_EFFECT
     "  -E      Activate channel effect processing\n"
#endif /* CHANNEL_EFFECT */
	 "  -f      "
#ifdef FAST_DECAY
	            "Disable"
...
/*<95GUI_MODIF_BEGIN>*/
#ifndef __WIN95__
	static /*static removed : I need to call this function in another file*/
#endif /* __WIN95__ */
/*<95GUI_MODIF_END>*/
...
/*<95GUI_MODIF_BEGIN>*/
	  // changed hard coded '/' to PATH_SEP
  ...
  if (argc==1)
    {
      interesting_message();
/*<95GUI_MODIF_BEGIN>*/
	  /* removed this return : a midi file may be open later within the GUI */
#ifndef __WIN95__
	  return 0; 
#endif /* __WIN95__ */
/*<95GUI_MODIF_END>*/
...
/*<95GUI_MODIF_BEGIN>*/
/* added : setting default swiches according to ini file before command
 line analysis
 */
#ifdef __WIN95__
  if( InitTimidity() )
...
/*<95GUI_MODIF_END>*/
  ...
  while ((c=getopt(argc, argv, "UI:P:L:c:A:C:ap:fp:o:O:s:Q:FD:hi:Ep:"
#if defined(AU_LINUX) || defined(AU_WIN32)
		   "B:" /* buffer fragments */
#endif
		   ))>0)
...
/*<95GUI_MODIF_BEGIN>*/
	  /* removed the 'return 1;' : bis a midi file may be open later within the GUI */
...
/*<95GUI_MODIF_BEGIN>*/
	  /* removed the if() condition : third time  -> a midi file may be open later within the GUI */
  if (/*optind<argc*/1)
/*<95GUI_MODIF_BEGIN>*/
    {
