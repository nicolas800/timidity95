...
/*<95GUI_MODIF_BEGIN>*/
	/* 3 modification performed on this file Nicolas Witczak juin 1998 */
/*<95GUI_MODIF_END>*/


#ifdef __WIN32__
/*<95GUI_MODIF_BEGIN>*/
	#include <stdio.h>	/* required for SEEK_SET to be surely defined */
/*<95GUI_MODIF_END>*/
#include <stdlib.h>
#include <io.h>
#include <string.h>
...
/*<95GUI_MODIF_BEGIN>*/  /* 32: bytes/sample */ "\002\000" /*<95GUI_MODIF_END>*/
...
static int open_output(void)
{
  ...
  *((int *)(RIFFheader+28))=LE_LONG(t);
  ...
  if ((dpm.encoding & (PE_MONO | PE_16BIT)) == PE_MONO)
    RIFFheader[32]='\001';  
  /*<95GUI_MODIF_BEGIN> patched to obtain 4 number when 16 bits /stereo */
  else if( ((dpm.encoding & PE_MONO) == 0) && (dpm.encoding & PE_16BIT) )
    RIFFheader[32]='\004';
  /*<95GUI_MODIF_END>*/
