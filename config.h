...
/*<95GUI_MODIF_BEGIN>*/
	...
	/* 2 modifications performed on this file 
	+ added control for win95 GUI
	+ added a compile time flag for switching effect processing
	Nicolas Witczak */

/* compile time flag for switching effect processing (experimental)
*/
...
/* <95GUI_MODIF_BEGIN> */ /* with channel effect support small small buffer are 
	prohibitive performance hit */
#ifdef __WIN32__
#define AUDIO_BUFFER_BITS 12
#elif defined( CHANNEL_EFFECT )
#define AUDIO_BUFFER_BITS 13
#else
...
#  include <math.h>
/*<95GUI_MODIF_BEGIN>*/
/* #  define PI M_PI  changed to #define PI 3.14159265358979323846 */
#define PI 3.14159265358979323846
/*<95GUI_MODIF_END>*/
