...
*/
/*<95GUI_MODIF_BEGIN>*/
	/* modifications performed on this file 
	minor modifications in order to add channel effects
	Nicolas Witczak july 1998 */
/*<95GUI_MODIF_END>*/
      ...
      else
	{
	  ...
	  switch(laststatus)
		...
		switch(a)
		  ...
		  /*<95GUI_MODIF_BEGIN>*/
          case 74 : /* filter */
              ctl->cmsg(CMSG_TEXT, VERB_VERBOSE," + filter effect on channel %i , ampl %i", lastchan + 1 , b) ;
              control=ME_CHANNEL_EFFECT; break ;
          case 91 : /* reverb */
              ctl->cmsg(CMSG_TEXT, VERB_VERBOSE," + reverb effect on channel %i , ampl %i", lastchan + 1 , b) ;
              control=ME_CHANNEL_EFFECT; break ;
		  case 92 : /* tremolo*/
			  ctl->cmsg(CMSG_TEXT, VERB_VERBOSE," + tremolo effect on channel %i , ampl %i", lastchan + 1 , b) ;
              control=ME_CHANNEL_EFFECT; break ;
		  case 93 : /* chorus */
			  ctl->cmsg(CMSG_TEXT, VERB_VERBOSE," + chorus effect on channel %i , ampl %i", lastchan + 1 , b) ;
              control=ME_CHANNEL_EFFECT; break ;
          case 94 : /* celeste( detune ) */
			  ctl->cmsg(CMSG_TEXT, VERB_VERBOSE," + celeste ( detune ) effect on channel %i , ampl %i", lastchan + 1 , b) ;
              control=ME_CHANNEL_EFFECT; break ;
          case 95 : /* phaser */
			  ctl->cmsg(CMSG_TEXT, VERB_VERBOSE," + phaser effect on channel , channel %i , ampl %i", lastchan + 1 , b) ;
              control=ME_CHANNEL_EFFECT; break ;
		...
		if (control != 255)
		  { /*<95GUI_MODIF_BEGIN>*/ /* save a value*/
			   MIDIEVENT(at, control, lastchan, b, a); 
		  } /*<95GUI_MODIF_END>*/
	      }
	      break;
